  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white rounded-xl shadow-lg p-10 flex flex-col items-center max-w-md w-full">
        <img src="/vite.svg" alt="BatterySync Logo" className="w-16 h-16 mb-4" />
        <h1 className="text-3xl font-bold mb-2 text-gray-900">BatterySync</h1>
        ...
        <p className="text-xs text-gray-400 mt-4">© 2025 BatterySync</p>
      </div>
    </div>
  );
} 